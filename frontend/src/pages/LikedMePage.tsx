...
const LikedMePage: React.FC = () => {
  ...
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    const selector = ".liked-me-page-header-inner";
  ...
  const containerHeight = React.useMemo(
    () => `calc(100vh - ${headerHeight}px - var(--liked-me-bottomnav-h, 48px))`,
    [headerHeight]
  );
  ...
  return (
    <div className="bg-white text-gray-900">
      <PageHeader
        ...
        onBack={handleBack}
        position="fixed"
        containerClassName="max-w-md mx-auto liked-me-page-header-inner"
